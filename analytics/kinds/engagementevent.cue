...
// This is our EngagementEvent definition, which contains kind metadata. It is the same across all versions of the kind.
engagementEventKind: {
    ...
    // (for example, engagementEventv1alpha1) instead.
    codegen: {
        // [OPTIONAL]
